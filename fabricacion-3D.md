...
Todas las piezas plásticas de la bomba de jeringa pueden ser impresas con [impresoras 3D][impresora 3D](parts/herramientas/impresora-3D.md){qty: 1, cat: herramientas}, estilo Rep-Rap, y con [filamento PLA](parts/insumos/filamento-pla.md){qty: 200g , cat: insumos}.
...
2. Limpia los remanentes de impresión con un [cuchillo de hoja retráctil](parts/herramientas/cuchillo-hoja-retractil.md){qty: 1,cat: herramientas}:

* Sostén el cuchillo en tu mano dominante con tus cuatro dedos alrededor del mango, dejando libre tu pulgar.
* Sostén la pieza plástica en tu otra mano, en la zona más alejada posible de las superficies a ser cortadas.
